...
export class EditPollModal extends Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(event) {
        ...
        fetch('https://pegasus-backend.herokuapp.com/admin/updatepoll/' + event.target.pollid.value, {
            method: 'PUT',
            headers: {
            ...
            .then((result) => {
                //alert(result);
                this.setState({ snackbaropen: true, snackbarmsg: 'Successfully updated poll!' });
            },
                (error) => {
                    //alert('Failed')
                    this.setState({ snackbaropen: true, snackbarmsg: 'Failed to update poll...' });
                }
            )
    }
                                ...
                                <Form onSubmit={this.handleSubmit}>
                                    ...
                                    <Form.Group controlId="pollid">
                                        ...
                                        <Form.Control
                                            ...
                                            required
                                            disabled
                                            defaultValue={this.props.pollid}
                                            placeholder="pollid"></Form.Control>
                                    </Form.Group>
