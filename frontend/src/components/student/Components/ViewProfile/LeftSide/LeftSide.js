    ...
    return(
        <React.Fragment>
            <Container>
                ...
                <Card.Body className={classes.CentralContent}>
                    ...
                    <ListGroupItem className={classes.CentralContent}>{props.details.FirstName} {props.details.MiddleName} {props.details.LastName}</ListGroupItem>
                        <ListGroupItem> <i className="fas fa-flag"></i> {props.details.Nationality}</ListGroupItem>
                        <ListGroupItem className={classes.Clickable}> <i className="fas fa-envelope"></i> {props.details.Email}</ListGroupItem>
