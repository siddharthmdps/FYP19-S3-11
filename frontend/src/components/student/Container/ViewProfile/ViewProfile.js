            ...
            <Container fluid>
                ...
                <Row >
                    ...
                    <Col md={{ offset: 3, span: 9 }} >
                        ...
                        {/* <body > */}
                        <Tab activeTab={this.state.ActiveTab} click={this.updateActiveTab} Education={this.state.Education} WorkExp = {this.state.WorkExp} Certification={this.state.Certification} Awards = {this.state.Awards} Projects={this.state.Projects} Skills={this.state.Skills}>
