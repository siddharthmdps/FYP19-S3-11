                ...
                <Tab.Container id="tab">
                    <Row className={classes.ProjectMM}>
                        <Col md={2} className={classes.LeftSide}>
                            ...
                            <Nav variant="pills" className="flex-column" onSelect={(event)=>{this.DPhandler(event)}}>
                                <Nav.Item>
                                <Nav.Link eventKey="Sid">Siddharth Singh</Nav.Link>
                                </Nav.Item>
                                <br />
                                <Nav.Item>
                                <Nav.Link eventKey="Joshua">Joshua Cheng Chee Yan</Nav.Link>
                                </Nav.Item>
                                <br />
                                <Nav.Item>
                                <Nav.Link eventKey="Soon">Lum Soon Keong</Nav.Link>
                                </Nav.Item>
                                <br />
                                <Nav.Item>
                                <Nav.Link eventKey="MinMarn">Min Marn OO</Nav.Link>
                                </Nav.Item>
                                <br />
                                <Nav.Item>
                                <Nav.Link eventKey="MinSan">Min San</Nav.Link>
                                </Nav.Item>
                                <br />
                                <Nav.Item>
                                <Nav.Link eventKey="Zhiting">Zhi Ting Chia</Nav.Link>
                                </Nav.Item>
                                <br />
                            </Nav>
                        </Col>
